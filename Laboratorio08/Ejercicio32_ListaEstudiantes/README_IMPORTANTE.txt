=====================================================
  Ejercicio32_ListaEstudiantes - INSTRUCCIONES DE IMPORTACIÓN
=====================================================

1. IMPORTAR EN ANDROID STUDIO:
   File > Open > seleccionar la carpeta "Ejercicio32_ListaEstudiantes"
...
2. GOOGLE-SERVICES.JSON (OBLIGATORIO):
   ...
   - Cópialo en la carpeta: Ejercicio32_ListaEstudiantes/app/
   - Asegúrate de que el package name coincida con: com.lab08.ejercicio32
