=====================================================
  Ejercicio31_RegistroEstudiante - INSTRUCCIONES DE IMPORTACIÓN
=====================================================

1. IMPORTAR EN ANDROID STUDIO:
   File > Open > seleccionar la carpeta "Ejercicio31_RegistroEstudiante"
...
2. GOOGLE-SERVICES.JSON (OBLIGATORIO):
   ...
   - Cópialo en la carpeta: Ejercicio31_RegistroEstudiante/app/
   - Asegúrate de que el package name coincida con: com.lab08.ejercicio31
