=====================================================
  RepositorioFB - INSTRUCCIONES DE IMPORTACIÓN
=====================================================

1. IMPORTAR EN ANDROID STUDIO:
   File > Open > seleccionar la carpeta "RepositorioFB"
...
2. GOOGLE-SERVICES.JSON (OBLIGATORIO):
   ...
   - Cópialo en la carpeta: RepositorioFB/app/
   - Asegúrate de que el package name coincida con: com.norbel.repositoriofb
